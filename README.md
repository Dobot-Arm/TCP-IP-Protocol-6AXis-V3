...
- 必填参数详解：6
  ...
  | 参数名         | 类型   | 含义                                                         | 是否必填 |
  | -------------- | ------ | ------------------------------------------------------------ | -------- |
  | J1            | double | P1点J1 轴位置，单位：度                                     | 是       |
  | J2            | double | P1点J2 轴位置，单位：度                                     | 是       |
  | J3            | double | P1点J3 轴位置，单位：度                                     | 是       |
  | J4            | double | P1点J4 轴位置，单位：度                                     | 是       |
  | J5            | double | P1点J5 轴位置，单位：度                                     | 是       |
  | J6            | double | P1点J6 轴位置，单位：度                                     | 是       |
